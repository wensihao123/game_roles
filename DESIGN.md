...
> 状态:待审  
> 日期:2026-07-11(同日第二版:理论库 philosophy/systems 层全部完工后,§4 / §6.1 / §8 职责设计已对齐全量理论)  
...
| Systems(7 系统群 24 篇 + system-map/framework/integration-rules) | **四事实源(ARCHITECTURE/BALANCE/STATE-MACHINES/UX-MAP)= Systems 理论在项目内的实例化**;各守护 skill 是对应系统群的执行者 |
